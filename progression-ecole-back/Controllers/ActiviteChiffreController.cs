...
{
    [ApiController]
    [Route("api/activite-chiffre")]
    public class ActiviteChiffreController : ControllerBase
    {
        private readonly ActiviteChiffreRepository _repo;

        public ActiviteChiffreController(ActiviteChiffreRepository repo)
        {
            _repo = repo;
        }

        [HttpGet("eleve/{eleveId}/periode/{periode}")]
        public ActionResult<ActiviteChiffre> GetByEleveAndPeriode(string eleveId, string periode)
        {
        ...
        public ActionResult<List<ActiviteChiffre>> GetByEleve(string eleveId)
        {
        ...
        [HttpPost]
        public IActionResult Save([FromBody] ActiviteChiffre activite)
        {
